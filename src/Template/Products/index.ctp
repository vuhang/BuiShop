...
<!--top-header-->
    ...
    <table class="table table-bordered">
                <thead>
                <h2 class="example">TABLE PRODUTS</h2>
                  <tr>
                    <th>Name</th>
                    <th>number</th>
                    <th>source</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $id->img ?></td>
                    <td><?= $id->Price ?></td>
                    <td><?= $this->Html->link('Edit','/products/edit/' .$id->id)?></td>
                    <td><?=$this->Form->postLink('Delete','/products/delete/' . $id->id,
