        ...
        <div class="col-md-offset-3 col-md-6 account-left" style="font-family: sans-serif;font-size: 18px;">
          ...
          <div class="account-top heading">
            <h3 style="color: darkred;margin-left: 28%;
                font-size: 32px;">EDIT USERS</h3>
          </div>
          <div><?= $this->Form->create($users)?></div>
          <div class="address">
          ...
          <div class="checkbox"><b>Sex</b>
           <label><input type="checkbox" name="sex" value="1"> Nam</label>
           <label><input type="checkbox" name="sex" value="2"> Nữ</label>
          </div>
    ...
    <div class="footer-text">
        <div class="container">
            <div class="footer-main">
                <p class="footer-class">Bùi Store đồng hành trên con đường thành công của bạn ! </p>
            </div>
        </div>
        <script type="text/javascript">
